...
local function setup()
  ...
  vim.g.trae_filetypes = {json = true, yaml = true, plantuml = true, dot = true, fennel = true, lua = true, vim = true, racket = true, ruby = true, rbs = true, eruby = true, crystal = true, python = true, sh = true, swift = true, go = true, rust = true, c = true, cpp = true, objc = true, make = true, ["*"] = false, markdown = false, text = false}
  local function _1_()
