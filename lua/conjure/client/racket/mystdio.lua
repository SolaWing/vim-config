-- [nfnl] Compiled from fnl/conjure/client/racket/mystdio.fnl by https://github.com/Olical/nfnl, do not edit.
...
config.merge({client = {racket = {mystdio = {mapping = {start = "cs", stop = "cS", interrupt = "ei", enter = "ea"}, command = "racket -i", prompt_pattern = "\n?[\"%w%-./_~]*> "}}}})
local cfg = config["get-in-fn"]({"client", "racket", "mystdio"})
