...
if has("nvim")
    ...
    nmap <buffer> <LocalLeader>t :update <bar> Dispatch -dir=<C-R><C-O>=g:rubytest_dir ?? v:lua.require("config.ft.ruby").rspec_dir()<CR> <C-R><C-O>=v:lua.require("config.ft.ruby").test_cmd("line")<CR><CR>
    nmap <buffer> <LocalLeader><C-t> :update <bar>
                \ let @* = v:lua.require("config.ft.ruby").test_cmd("line")<CR>
    nmap <buffer> <LocalLeader><M-t> :Dispatch -dir=<C-R><C-O>=g:rubytest_dir ?? v:lua.require("config.ft.ruby").rspec_dir()<CR> <C-R><C-O>=v:lua.require("config.ft.ruby").test_cmd("file")<CR><CR>
    " all
    nmap <buffer> <LocalLeader>T :Dispatch -dir=<C-R><C-O>=g:rubytest_dir ?? v:lua.require("config.ft.ruby").rspec_dir()<CR> <C-R><C-O>=v:lua.require("config.ft.ruby").test_cmd("all")<CR><CR>
else
    " current line
